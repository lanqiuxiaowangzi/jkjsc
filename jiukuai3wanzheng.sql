...
CREATE TABLE `cart_cartitem` (
  ...
  CONSTRAINT `cart_cartitem_user_id_292943b8_fk_User_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_user3` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `cart_cartitem` */

insert  into `cart_cartitem`(`id`,`goodsid`,`colorid`,`sizeid`,`count`,`isdelete`,`user_id`) values (1,2,5,5,3,0,3),(2,3,7,9,2,0,3);
...
CREATE TABLE `order_order` (
  ...
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `out_trade_num` (`out_trade_num`),
  KEY `order_order_address_id_f6eb43ad_fk_User_address_id` (`address_id`),
  ...
  CONSTRAINT `order_order_address_id_f6eb43ad_fk_User_address_id` FOREIGN KEY (`address_id`) REFERENCES `user_address` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `order_order` */

insert  into `order_order`(`out_trade_num`,`id`,`order_num`,`trade_no`,`status`,`payway`,`address_id`,`user_id`) values ('cc3bdf1e4d094b9ea5a2bc73f2a9fee9',2,'20180111170749','','待付款','alipay',6,2),('bc1096ae5f684cf7a33715b7839329fb',3,'20180111170755','','待付款','alipay',6,2),('bad272e2f9404299a8b6d814383829bc',4,'20180111171834','2018011121001004320200205855','待发货','alipay',6,2);
...
/*Data for the table `order_orderitem` */

insert  into `order_orderitem`(`id`,`goodsid`,`colorid`,`sizeid`,`count`,`order_id`) values (3,2,5,6,4,2),(4,3,8,9,2,2),(5,4,10,6,1,4);
...
insert  into `user_address`(`id`,`name`,`phone`,`address`,`isdefault`,`user_id`) values (6,'1','12345678901','北京市,市辖区,东城区,111',1,2);
...
insert  into `user_user`(`id`,`account`,`password`) values (1,'123456@qq.com','123456'),(2,'12345678@qq.com','e10adc3949ba59abbe56e057f20f883e');

/*Table structure for table `user_user3` */

DROP TABLE IF EXISTS `user_user3`;

CREATE TABLE `user_user3` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `user_user3` */

insert  into `user_user3`(`id`,`account`,`password`) values (1,'admin','a78ae8dc9a41d1c183ca3bdba0c6d9d9'),(2,'123456','e10adc3949ba59abbe56e057f20f883e'),(3,'123456789@qq.com','e10adc3949ba59abbe56e057f20f883e'),(4,'123456@qq.com','e10adc3949ba59abbe56e057f20f883e');
